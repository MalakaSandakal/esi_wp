jQuery(document).ready(function ($) {
   ...
   $(document).on("click", ".upload_slider_button_2", function (e) {
      e.preventDefault();
      var $button = $(this);
      var id
      var count;
      $(".upload_slider_button_2").each(function () {
         if (e.target.dataset.id == this.name) {
            id = e.target.dataset.id;
            count = this.dataset.count;
         }
   ...
   $(document).on("click", ".upload_image_button_2", function (e) {
      e.preventDefault();
      var $button = $(this);
      var id
      $(".upload_image_button_2").each(function () {
         if (e.target.dataset.id == this.name) {
            id = e.target.dataset.id;
            count = this.dataset.count;
         }
